exports.htmlForgotPassword = (name, url) => {
    return ` <html>
    <head>
        <meta charset="UTF-8">
        ...
        <main style="color: #212529;">
            ...
            <div style="padding-bottom:20px">
                ...
                <div style="color: #212529;width: 600px; margin: auto; text-align: justify; font-size: 16px;">
                    ...
                    Anh/Chị đã đăng ký tài khoản thành công. Vui lòng nhập mã code <p style="display: inline; font-weight: bold;">""</p> để được kích hoạt tài khoản. <br> <br>
                ...
                <div  style="text-align: center;margin-top: 20px;margin-bottom: 20px;">
                    <a style="border-radius: 5px;font-weight: 600;padding: 18px;background-color: #F0BD71;font-size:18px;color: #fff;text-decoration: none;cursor: pointer;" href="${url}">Xác nhận</a>
                </div>
